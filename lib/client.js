...
try {
    ...
    console.log("🌍 Connected to the ASWIN DB")
} catch {
...
setTimeout(() => {
	...
	try{
		...
		console.log('Could not connect with Mongodb.\nPlease visit https://youtube.com/@sparkymon777')
	}
    }
    main()
    //========================================================================================================================================
...
<html>
  ...
  <body>
    <section>
      Hello from ASWIN SPARKY!
    </section>
  </body>
</html>
`
app.get("/", (req, res) => res.type('html').send(html));
app.listen(port, () => console.log(`ASWIN Server listening on port http://localhost:${port}!`));
